...
## 1. Volksgruppen-Terminologie

Dies sind die definitorisch präzisesten Begriffe auf der Website. Die Seite
**Definitionen** gibt exakte numerische Schwellenwerte an; Übersetzungen müssen
diese Schwellenwerte unverändert wiedergeben.

---

### Volksgruppe ★ Kernbegriff

- **Definition auf der Website**: „Eine ethnolinguistische Gruppe, deren
  Mitglieder eine gemeinsame Zusammengehörigkeit auf der Grundlage von Sprache,
  Kultur, Religion und Weltanschauung wahrnehmen … die größtmögliche Gruppe,
...
- **Warum dieser Begriff wichtig ist**: Dies ist die grundlegende Maßeinheit
  ...
  primitivierenden Konnotationen) oder „soziale Gruppe" wiedergegeben werden.
  Eine ungenaue Übersetzung macht jede Statistik ungültig.
...
- **Definition auf der Website**: „Hat annähernd 2 Jünger/innen oder weniger
  ...
  kulturübergreifende Unterstützung einheimische Gemeinden zu etablieren."
  (Seite „Definitionen")
- **Beispiel**: „Globale Partnerschaft für die Unerreichten" (Slogan der Website)
- **Warum dieser Begriff wichtig ist**: Der Schwellenwert (≤ 2 %) muss in der
  Übersetzung reproduzierbar sein. Das Konzept der *fehlenden Kapazität* zur
  eigenständigen Ausbreitung ist ebenso wichtig wie der Prozentsatz. Formulierungen
  vermeiden, die implizieren, die Gruppe sei geistlich „nicht auserwählt" oder
...
- **Warum dieser Begriff wichtig ist**: UUPG ist eine etablierte Abkürzung in
  ...
  eine einheitlich verwendete Formulierung in jeder Sprache beibehalten, um die
  Ausrichtung auf internationale Gebetswerkzeuge sicherzustellen.
...
- **Warum dieser Begriff wichtig ist**: „Frontier" signalisiert die
  ...
  Unerreichten. Militärische Konnotationen dort vermeiden, wo dies kulturell
  sensibel ist; den Sinn von „allererstem" Evangeliumskontakt bewahren.

---

### Ethnolinguistische Gruppe

- **Bedeutung**: Die technische Beschreibung dessen, was eine Volksgruppe
  ausmacht (gemeinsame Sprache, Kultur, Religion, Weltanschauung). Wird nicht
  als eigenständige Bezeichnung in der Benutzeroberfläche verwendet, sondern
  ist in der Definition auf der Seite „Definitionen" eingebettet.
- **Warum dieser Begriff wichtig ist**: Übersetzer/innen sollten verstehen, dass
  dies das zugrundeliegende Konzept ist, damit sie ethnizitäts- und
  sprachorientierte Begriffe wählen, keine politischen.

---

## 2. Engagement- und Missionssprache
...
### Zugang zum Evangelium ★ Kernbegriff
...
- **Warum dieser Begriff wichtig ist**: „Zugang" impliziert Verfügbarkeit und
  Erreichbarkeit, nicht nur geografische Präsenz. Eine Fehlübersetzung als
  „Evangeliumswissen" oder „Evangeliumshören" verändert die Bedeutung subtil,
  aber bedeutsam.
...
- **Definition auf der Website**: „Eine Multiplikation einheimischer Gemeinden,
  ...
  Generationen, die zusammen mehr als 1.000 Personen umfassen."
  (Seite „Definitionen")
- **Beispiel**: „Gemeindegründungsbewegungen unter jedem unerreichten Volk der
  Erde" (Ziel der Startseite)
- **Warum dieser Begriff wichtig ist**: „Bewegung" impliziert sich selbst
  multiplizierende Dynamik, keine einzelne Gemeindegründung oder ein Programm.
  Die Kennzahlen (4 Stränge × 4 Generationen × 1.000 Personen) müssen
  übersetzbar sein; Formulierungen vermeiden, die wie eine soziale oder
  politische Bewegung klingen.

---

### Einheimische Gemeinde

- **Bedeutung**: Eine Gemeinde, die aus der Volksgruppe selbst heraus entsteht
  und in den „fünf Selbst" selbsttragend und reifend ist.
- **Beispiel**: „Es gibt eine einheimische Gemeinde, die unter jeder Volksgruppe
  auf der Erde gegründet wurde" (Visionsziele); „besitzt nicht die Kapazität,
  ohne kulturübergreifende Unterstützung einheimische Gemeinden zu etablieren"
  (Definitionen)
- **Warum dieser Begriff wichtig ist**: „Einheimisch" bedeutet lokal verwurzelt
  und selbst verwaltend, nicht „Naturreligion" oder „animistisch". Bei Bedarf
  klarstellen, um Assoziationen mit Synkretismus zu vermeiden.

---

### Die fünf „Selbst" (einer einheimischen Gemeinde)

- **Bedeutung**: Die fünf Merkmale einer reifen einheimischen Gemeinde:
  selbst-ausbreitend, selbst-verwaltend, selbst-tragend, selbst-theologisierend,
  selbst-missionierend. (Seite „Definitionen")
- **Warum dieser Begriff wichtig ist**: Dies ist ein standardisiertes
  Missionsrahmenwerk. Übersetzer/innen sollten etablierte Entsprechungen
  verwenden, wenn sie in der Zielsprache vorhanden sind; andernfalls braucht
  jede „Selbst-"-Verbindung eine einheitliche Wiedergabe.
...
- **Warum dieser Begriff wichtig ist**: „Ansässig" versus „nicht ansässig" ist
  ...
  einfach auf „Missionare" reduzieren.

---

### Kulturübergreifende Mitarbeiter/innen

- **Bedeutung**: Missionsmitarbeiter/innen aus einer anderen Kultur, die unter
  einer Volksgruppe dienen. In manchen Kontexten als bevorzugter Begriff
  gegenüber „Missionar/in" verwendet.
- **Beispiel**: „besitzt nicht die Kapazität, ohne kulturübergreifende
  Unterstützung einheimische Gemeinden zu etablieren" (Definitionen)
- **Warum dieser Begriff wichtig ist**: Das Qualifikationsmerkmal
  „kulturübergreifend" ist beabsichtigt — es handelt sich nicht um
  Mitarbeiter/innen aus der Gruppe selbst. Einen Begriff verwenden, der
  kulturelle Differenz vermittelt, nicht nur „ausländisch".
...
- **Bedeutung**: Die anfängliche Evangelisierungsphase unter einer
  Frontier-Volksgruppe, wo es zunächst keine Gläubigen gibt.
- **Beispiel**: „Die Pionierarbeit muss in der Regel mit Nichtgläubigen beginnen"
  (Seite „Definitionen")
- **Warum dieser Begriff wichtig ist**: Übersetzer/innen sollten „von Grund auf
  neu beginnen" hinsichtlich der Evangeliumspräsenz vermitteln.

---

### Herzenssprache

- **Bedeutung**: Die Erst- oder Muttersprache eines Menschen — die Sprache, in
  der er oder sie am tiefsten denkt und fühlt.
- **Beispiel**: „Einsatz für die lokale Kultur und Herzenssprache"
  (Seite „Definitionen")
- **Warum dieser Begriff wichtig ist**: Eine fest etablierte Formulierung in der
  Mission. Von „Amtssprache" oder „Handelssprache" unterscheiden. Das Konzept
  besagt, dass Evangeliums- und Jüngerschaftsarbeit in dieser Sprache geschehen
  muss, um vollständig wirksam zu sein.
...
- **Bedeutung**: Eine kollektive, sich multiplizierende Bewegung von Menschen
  ...
  zu vereinzelten Bekehrungen.
- **Beispiel**: „Keine bestätigte, anhaltende Bewegung hin zu Jesus"
  (Definition der Frontier-Volksgruppe)
- **Warum dieser Begriff wichtig ist**: Hier geht es speziell um eine *anhaltende,
  sich multiplizierende* geistliche Bewegung, keine individuelle Bekehrung oder
  sozialen Aktivismus.
...
- **Bedeutung**: Angehörige einer Volksgruppe, die außerhalb ihrer Heimat leben.
  Als Komponente des breiteren Engagements aufgeführt.
- **Beispiel**: „Arbeit unter der Diaspora" (Seite „Definitionen")
- **Warum dieser Begriff wichtig ist**: In vielen Sprachen oft ein Lehnwort; wenn
  ja, kann es beibehalten werden. Klarstellen, dass es *verstreute Gemeinschaften*
  einer Volksgruppe bedeutet, nicht Flüchtlinge im Allgemeinen.

---

## 3. Gebet und Fürbitte
...
- **Warum dieser Begriff wichtig ist**: „Täglich" ist beabsichtigt und Teil der
  ...
  „gelegentliches Gebet" wiedergeben.
...
- **Warum dieser Begriff wichtig ist**: Die mathematische Logik muss übersetzbar
  ...
  gelesen wird; es bedeutet *ununterbrochenes Gebet den ganzen Tag*.

---

### Fürbitter/in / Fürbitter/innen

- **Bedeutung**: Eine Person, die sich verpflichtet, für eine UUPG zu beten.
  Ziel: 144+ pro UUPG (für 24-Stunden-Abdeckung), dann 1.000+ pro UUPG.
- **Beispiel**: „144+ tägliche Fürbitter/innen aufbauen, die täglich 10 Minuten
  beten." (Seite „Adoptieren")
- **Warum dieser Begriff wichtig ist**: Den etablierten kirchlichen Begriff für
  Fürbitter/in bzw. Gebetskämpfer/in verwenden, keine gerichtlichen oder
  staatlichen Konnotationen.
...
- **Bedeutung**: Eine theologische Überzeugung, dass Fürbitte geistliche
  ...
  überhaupt ankommen.
- **Beispiel**: „Gebet erweicht Herzen, öffnet Türen und lädt das Wirken des
...
- **Beispiel**: „Gemeinden und Netzwerke übernehmen Verantwortung — durch
  ...
  (Startseite); „Durch Beten, Geben und Senden mitwirken"
  (Seite „Adoptieren")
- **Warum dieser Begriff wichtig ist**: Diese Trias wird durchgängig verwendet.
  Alle drei Handlungen sollten mit aktiven, partizipativen Verben übersetzt
  werden, nicht mit passiven oder frommen.

---

### Mobilisieren / Mobilisierung

- **Bedeutung**: Fürbitter/innen und Teilnehmende in einer Gemeinde oder einem
  Netzwerk aufbauen und aktivieren.
- **Beispiel**: „144+ tägliche Fürbitter/innen aufbauen" / „Werkzeuge zur
  Mobilisierung von Gebet und Teilhabe in deiner Gemeinde"
  (Seite „Adoptieren")
- **Warum dieser Begriff wichtig ist**: „Mobilisieren" impliziert aktive Bewegung
  auf ein Ziel hin. Passive Begriffe wie „informieren" oder „einladen" vermeiden.
...
- **Warum dieser Begriff wichtig ist**: „Priorität" signalisiert, dass dies das
  *einzig wichtigste* strategische Ziel ist, nicht eines unter vielen. Die
  Frist 2033 muss exakt beibehalten werden.

---

### Vision 2033

- **Bedeutung**: Die übergreifende Visions-Überschrift in der Benutzeroberfläche,
  die sich auf die für 2033 aufgeführten Ziele auf der Vision-Seite bezieht.
- **Beispiel**: „Vision 2033" (Überschrift der Startseite)
- **Warum dieser Begriff wichtig ist**: Eine Eigenname-Bezeichnung für die
  Zielmenge der Initiative. Die Jahreszahl intakt lassen.

---

### Jeder Stamm, jede Zunge, jedes Volk und jede Nation

- **Bedeutung**: Die biblische Vision aus Offenbarung 7,9 — das Bild der
  endgültigen Anbetung, das die Mission motiviert.
- **Beispiel**: „Jesus ist würdig, Herrlichkeit zu empfangen von jedem Stamm,
  jeder Zunge, jedem Volk und jeder Nation." (Seite „Über uns" —
  Sending Summit Declaration)
- **Warum dieser Begriff wichtig ist**: An der etablierten Bibelübersetzung in
  der Zielsprache ausrichten. Alle vier Substantive sind theologisch beabsichtigt —
  Stamm (Clan/Familie), Zunge (Sprache), Volk (ethnische Gruppe), Nation
  (politische Einheit) — jedes erfasst eine andere Dimension menschlicher
  Vielfalt.
...
- **Warum dieser Begriff wichtig ist**: „Partnerschaft" signalisiert, dass es
  ...
  Mitgliedswerken, die durch das Netzwerk zusammenarbeiten.

---

## 6. Gemeinde-, Jüngerschafts- und theologische Begriffe

---

### Jünger/in / Jünger/innen (als Kennzahl)

- **Bedeutung**: Nachfolger/innen Jesu, die getauft, versammelt und zur
  Weitergabe fähig sind. Wird als Maßeinheit für Engagementschwellenwerte
...
- **Warum dieser Begriff wichtig ist**: Das etablierte christliche Wort für
  ...
  Bedeutung verbunden bleiben.

---

### Getaufte Jünger/innen

- **Bedeutung**: Die formale Definition von Gemeindemitgliedschaft auf
  Doxa.Life — Menschen, die Jesus in der Gläubigentaufe nachgefolgt sind und
  durch den Heiligen Geist zusammengeführt werden.
- **Beispiel**: „Eine Gemeinde besteht aus getauften Jüngern/innen, die durch
  den Heiligen Geist zusammengeführt werden" (Seite „Definitionen")
- **Warum dieser Begriff wichtig ist**: „Getauft" ist ein Qualifikationsmerkmal,
  das nominelle Zugehörigkeit von echter Mitgliedschaft unterscheidet.

---

### Jünger/innen zu machen aus allen Völkern

- **Bedeutung**: Das Großer-Auftrag-Mandat aus Matthäus 28,19, das im
  Missionsteil zitiert wird.
- **Beispiel**: „Zur Ehre Gottes, Jünger/innen aus allen Völkern zu machen durch
  Gehen, Taufen und Lehren." (Vision-Seite — Mission)
- **Warum dieser Begriff wichtig ist**: An der vertrauenswürdigen lokalen
  Bibelübersetzung ausrichten. „Völker" bedeutet hier ethnische Völker, keine
  Länder.
...
- **Warum dieser Begriff wichtig ist**: Kontextualisierungssprache — muss
  Anpassung an die Kultur vermitteln, ohne Kompromiss des Evangeliums zu
  implizieren.

---

### Selbsttragende Gemeinden

- **Bedeutung**: Gemeinden, die sich finanziell selbst tragen, sich selbst
  reproduzieren und sich selbst regieren können, ohne externe Abhängigkeit.
- **Beispiel**: „Es werden Anstrengungen unternommen, selbsttragende Gemeinden
  zu etablieren" (Vision-Seite — Engagement-Definition)
- **Warum dieser Begriff wichtig ist**: „Selbsttragend" unterscheidet sich von
  „unabhängig" — es impliziert gesunde Reife, keine Isolation.

---

### Geistliche Generationen (von Gemeinden)

- **Bedeutung**: Die Anzahl der „Generationen" von Gemeindegründungen, die eine
  Gemeindegründungsbewegung hervorgebracht hat (A gründet B, B gründet C,
...
- **Bedeutung**: Kernwert aus Johannes 15,5 — in einer fortlaufenden,
  abhängigen Beziehung mit Jesus zu bleiben als Quelle aller Fruchtbarkeit.
- **Beispiel**: „In Jesus bleiben (Johannes 15,5)" (Vision-Seite — Werte)
- **Warum dieser Begriff wichtig ist**: „Bleiben" trägt einen relationalen,
  fortlaufenden Sinn. Nicht als einmalige vergangene Handlung oder als
  physischen Ort wiedergeben.

---

### Ohne Unterlass beten

- **Bedeutung**: Kernwert aus 1. Thessalonicher 5,17 — die Haltung des
  fortlaufenden, gewohnheitsmäßigen Gebets, die der gesamten Gebetsvision von
  Doxa.Life zugrunde liegt.
- **Beispiel**: „Ohne Unterlass beten (1. Thessalonicher 5,17)" (Vision-Seite)
- **Warum dieser Begriff wichtig ist**: Die etablierte Bibelübersetzungsphrase
  verwenden. Kontinuität betonen, keine wörtliche Unmöglichkeit.

---

### Sich selbst verleugnen

- **Bedeutung**: Kernwert aus Lukas 9,23 — freiwilliges Selbstopfer, während
  Jünger/innen Jesus in die Mission nachfolgen.
- **Beispiel**: „Sich selbst verleugnen (Lukas 9,23)"
  (Vision-Seite — Werte)
- **Warum dieser Begriff wichtig ist**: Willige Selbstverleugnung um Christi
  willen vermitteln, keine Selbstverachtung oder Askese.

---

### Die Regionen jenseits erreichen

- **Bedeutung**: Kernwert aus 2. Korinther 10,16 — über die Orte
  hinausreichen, wo das Evangelium bereits gewesen ist.
- **Beispiel**: „Die Regionen jenseits erreichen (2. Korinther 10,16)"
  (Vision-Seite)
- **Warum dieser Begriff wichtig ist**: „Jenseits" signalisiert Frontier-/
  Pionierbereiche. Mit dem Konzept der Frontier-Volksgruppe verbinden.

---

## 7. Organisatorische und strukturelle Begriffe

---

### DOXA

- **Bedeutung**: Das griechische Wort für „Herrlichkeit" — der Name der
  Initiative, der betont, dass das Missionsziel Gottes Herrlichkeit ist, nicht
  menschliche Leistung.
- **Beispiel**: „DOXA ist das griechische Wort für ‚HERRLICHKEIT'." (Startseite)
- **Warum dieser Begriff wichtig ist**: Als Eigenname beibehalten. Eine kurze
  erklärende Anmerkung (z. B. „DOXA = Herrlichkeit auf Griechisch") kann dort
  hinzugefügt werden, wo der Name eingeführt wird, aber nicht übersetzen.
...
- **Warum dieser Begriff wichtig ist**: Ein Eigenname — nicht übersetzen. Bei
  Bedarf eine kurze erklärende Wendung hinzufügen
  („globale Assemblies-of-God-Gemeinschaft"). Das Akronym WAGF sollte auf der
  gesamten Website einheitlich gehalten werden.

---

### WAGF Missions Commission

- **Bedeutung**: Das Aufsichtsgremium innerhalb des WAGF, das die Führung von
  Doxa.Life ernennt und beaufsichtigt.
- **Beispiel**: „Unter der Aufsicht des WAGF Missions Commission Lead Team"
  (Über uns)
- **Warum dieser Begriff wichtig ist**: Ein institutioneller Eigenname; nicht
  übersetzen.
...
- **Bedeutung**: Die Gründungserklärung, die am 25. September 2025 in Lake
  Geneva, Minnesota, unterzeichnet wurde und die mit WAGF verbundenen Werke
  zur DOXA-Partnerschaft verpflichtet.
- **Beispiel**: „SENDING SUMMIT DECLARATION" (Überschrift der Seite „Über uns")
- **Warum dieser Begriff wichtig ist**: Ein Eigenname-Dokumentname; unverändert
  beibehalten oder einen kurzen Beschreiber in Klammern hinzufügen.

---

### Freiwillige, globale, empfangende Partnerschaft

- **Bedeutung**: Wie DOXA sich selbst beschreibt — Mitgliedswerke nehmen nach
  eigenem Entschluss teil, sie erstreckt sich über den Globus, und sie empfängt/
  koordiniert Missionare, anstatt sie direkt auszusenden.
- **Beispiel**: „Wir werden eine Freiwillige, Globale, Empfangende Partnerschaft
  bilden" (Sending Summit Declaration)
...
- **Bedeutung**: Die Zusammenfassung der WAGF-Überzeugungen, aufgeführt auf
  doxa.life/about/statement-of-faith.
- **Warum dieser Begriff wichtig ist**: Den etablierten kirchlichen Begriff für
  „Lehraussage" oder „Glaubensbekenntnis" in der Zielsprache verwenden.
  Rechtlich klingende Begriffe vermeiden.

---

### Pfingstlich (Pentecostal)

- **Bedeutung**: Die theologische Tradition und das besondere Merkmal von
  WAGF/Assemblies of God, wie in der Einleitung des Glaubensbekenntnisses
  festgehalten.
- **Beispiel**: „Die dargelegte Wahrheit gilt als grundlegend für einen wahrhaft
  pfingstlichen Dienst." (Glaubensbekenntnis)
- **Warum dieser Begriff wichtig ist**: Eine theologische Eigenbezeichnung —
  als „pfingstlich" beibehalten (es wird in vielen Sprachen als Lehnwort weit
  verbreitet verwendet).

---

## 8. Begriffe des Glaubensbekenntnisses (theologisch)

Diese Begriffe erscheinen speziell auf der Seite des Glaubensbekenntnisses. Es
handelt sich um standardisierten Lehrwortschatz. Übersetzer/innen sollten
etablierte christliche Entsprechungen in der Zielsprache verwenden, anstatt neue
Übersetzungen zu erfinden.

| Begriff | Kurze Anmerkung |
|---------|----------------|
| **Wiedergeburt** | Bekehrung/Erneuerung — „von Neuem geboren" (Johannes 3,5–6) |
| **Erneuerung / Wiedergeburt** | Das Wirken des Heiligen Geistes zur geistlichen Erneuerung bei der Errettung |
| **Rechtfertigung** | Vor Gott durch den Glauben an Christus für gerecht erklärt werden |
| **Sühne / Versöhnung** | Christi stellvertretender Tod, der die Sünde der Menschheit bedeckt |
| **Heiligung** | Fortlaufende Absonderung vom Bösen und Hingabe an Gott |
| **Wassertaufe** | Gläubigentaufe durch Untertauchen (Matthäus 28,19; Apostelgeschichte 10,47–48) |
| **Abendmahl des Herrn / Kommunion** | Das Abendmahl mit Brot und Kelch (Lukas 22,14–20) |
| **Taufe im Heiligen Geist** | Eine eigenständige Erfahrung der Bevollmächtigung, bezeugt durch Zungenreden |
| **Zungenreden / in Zungen reden** | Das erste Zeugnis der Taufe im Heiligen Geist |
| **Gaben des Heiligen Geistes** | Übernatürliche Gaben (1. Korinther 12) |
| **Vormillenniale Wiederkunft** | Christi bevorstehende, persönliche, leibliche Wiederkunft vor dem Millennium |
| **Leibliche Auferstehung** | Physische Auferstehung der gesamten Menschheit am Ende der Zeit |

---

## 9. Navigations- und Aktionsbezeichnungen

Diese UI-Begriffe erscheinen als Seitentitel, Schaltflächenbeschriftungen und
Handlungsaufrufe. Einheitlichkeit in der Übersetzung ist für die Benutzerführung
entscheidend.

| Bezeichnung | Kontext | Übersetzungshinweis |
|-------------|---------|---------------------|
...
| **Definitionen** | Untermenü „Über uns" | Glossar-/Definitionsseite |
| **Vision** | Untermenü „Über uns" | Die Visions-Seite |
...
| **Warum Gebet wichtig ist** | Seite „Beten" | Motivations-Abschnittsüberschrift |

---

## Zusammenfassung: Kernbegriffe bestätigt

Alle elf vom Projektteam festgelegten Kernbegriffe wurden im Seiteninhalt
gefunden und sind oben mit websitespezifischen Definitionen und Beispielen
aufgeführt:
